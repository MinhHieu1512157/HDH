...
ExceptionHandler(ExceptionType which)
{
	...
	// xu ly cac which exception:
	//		NoException halt le he thong tra quyen cho hdh
	//		SyscallException xu ly cac type syscall
	//		cac exception khac xuat thong bao va halt lai he thong
	...
	case SyscallException:
		SystemCall(type); // xu ly cac type syscall
