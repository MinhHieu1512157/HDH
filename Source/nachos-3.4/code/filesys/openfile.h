...
class OpenFile {
  public:
// 1512479 - 1512157
    int type;  // type of open file: 0 = write and read, 1 = read only
    OpenFile(int f, int t = 0) { file = f; currentOffset = 0; type = t;} // open the file
// 1512479 - 1512157
...
// 1512479 - 1512157
    int type;  
    OpenFile(int sector, int t = 0);	// Open a file whose header is located
